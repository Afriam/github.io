    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="userdashboard.php">Dashboard
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdown1">
                    <li class="dropdown-item"><font id="text_deco"><a id="text_deco" href="appointmenthistory.php">Booking</a></font></li>
                </ul>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdown2">
                    <li class="dropdown-item"><a id="text_deco" href="medicalhistory.php"><font id="text_deco">
                    Medical History</a></font></li>
                    <li class="dropdown-item"><a id="text_deco" href="information.php"><font id="text_deco">
            ...
            <div class="nav-item dropdown">
                <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle user-action">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="logoutury.php" class="dropdown-item"><i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a>
                </div>
            </div>
        </div>
    </div>
